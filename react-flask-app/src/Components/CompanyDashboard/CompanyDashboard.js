        ...
        <Container className="mt-2">
            ...
            <div className="gridContainer">
                ...
                <Card className="mb-2 goalsCard">
                    <Card.Body>
                        <Card.Title>Company Goals</Card.Title>
                        <ul>
                            {companyData.goalsAndTargets && companyData.goalsAndTargets.goals.map((goal, index) => <li key={index}>{goal}</li>)}
                        </ul>
                        <hr />
                        <Card.Title>Mitigation Strategies</Card.Title>
                        <ul>
                            {companyData.goalsAndTargets && companyData.goalsAndTargets.mitigationStrategies.map((strategy, index) => <li key={index}>{strategy}</li>)}
                        </ul>
                    </Card.Body>
